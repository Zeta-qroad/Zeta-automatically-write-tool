...
# 버튼 5 생성 및 배치
button5 = tk.Button(root, text="이미지삭제", command=on_button5_click, **button_style)
button5.pack(pady=10)

# 버튼 1 생성 및 배치
button1 = tk.Button(root, text="확인", command=on_button1_click, **button_style)
button1.pack(pady=10)

# 버튼 2 생성 및 배치
button2 = tk.Button(root, text="검색 차단", command=on_button2_click, **button_style)
